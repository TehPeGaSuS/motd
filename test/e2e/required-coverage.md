...
| message bubbles, actions, audio, replies, placeholders, sync/error states | 44 fixture-free cases via `component-suite.sh`, including full-list variants and Paging replacement | phases C, G, and conditional H |
