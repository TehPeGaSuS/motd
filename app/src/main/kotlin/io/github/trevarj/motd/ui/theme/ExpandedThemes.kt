...
private fun darkEditorScheme(
    ...
    return darkColorScheme(
        primary = p,
        onPrimary = bg,
        primaryContainer = mix(bg, p, .18f),
        onPrimaryContainer = fg,
        secondary = s,
        onSecondary = bg,
        secondaryContainer = mix(bg, s, .16f),
        onSecondaryContainer = fg,
        tertiary = t,
        onTertiary = bg,
        tertiaryContainer = mix(bg, t, .16f),
        onTertiaryContainer = fg,
        background = bg,
        onBackground = fg,
        surface = sf,
        onSurface = fg,
        surfaceVariant = mix(sf, fg, .12f),
        onSurfaceVariant = mt,
        outline = mix(bg, mt, .65f),
        outlineVariant = mix(bg, mt, .35f),
...
private fun lightEditorScheme(
    ...
    return lightColorScheme(
        ...
        primaryContainer = mix(bg, p, .17f),
        onPrimaryContainer = fg,
        secondary = s,
        onSecondary = Color.White,
        secondaryContainer = mix(bg, s, .15f),
        onSecondaryContainer = fg,
        tertiary = t,
        onTertiary = Color.White,
        tertiaryContainer = mix(bg, t, .15f),
        onTertiaryContainer = fg,
        background = bg,
        onBackground = fg,
        surface = sf,
        onSurface = fg,
        surfaceVariant = mix(sf, fg, .09f),
        onSurfaceVariant = mt,
        outline = mix(bg, mt, .65f),
        outlineVariant = mix(bg, mt, .30f),
...
val ModusOperandiDeuteranopiaScheme =
    lightEditorScheme(
        0xFFFFFFFF,
        0xFFF2F2F2,
        0xFF000000,
...
val ModusVivendiDeuteranopiaScheme =
    darkEditorScheme(
        0xFF000000,
        0xFF1E1E1E,
        0xFFFFFFFF,
...
val ModusOperandiTritanopiaScheme =
    lightEditorScheme(
        0xFFFFFFFF,
        0xFFF2F2F2,
        0xFF000000,
...
val ModusVivendiTritanopiaScheme =
    darkEditorScheme(
        0xFF000000,
        0xFF1E1E1E,
        0xFFFFFFFF,
