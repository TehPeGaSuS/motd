...
class WebPushRegistrar
    ...
    constructor(
        ...
        private suspend fun registerOn(
            ...
            registrationLocks.getOrPut(networkId) { Mutex() }.withLock {
...
private fun Exception.toHealthErrorCode(): String =
    when (this) {
...
private fun PushKeys.toKeyMaterial() =
...
private fun WebPushCrypto.KeyMaterial.toPushKeys() =
    PushKeys(
