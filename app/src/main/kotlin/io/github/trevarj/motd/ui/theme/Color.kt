...
val SolarizedLightScheme =
    lightColorScheme(
        ...
        onBackground = Color(0xFF40545B),
        surface = Color(0xFFEEE8D5),
        onSurface = Color(0xFF40545B),
