...
interface HistorySyncPrefs {
    ...
    suspend fun setLastSuccessfulSync(
        networkId: Long,
        timestamp: Long,
    )
...
class HistorySyncPrefsImpl
    ...
    constructor(
        ...
        override suspend fun lastSuccessfulSync(networkId: Long): Long? = cursors.networkLastSuccessfulSync(networkId)
