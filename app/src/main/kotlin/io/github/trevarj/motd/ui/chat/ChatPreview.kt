    ...
    val messages =
        listOf(
            ...
            MessageEntity(
                ...
                bufferId = 1,
                msgid = "m7",
                serverTime = now - 20_000,
                sender = "me",
                kind = MessageKind.PRIVMSG,
                text = "on it, replying now",
                isSelf = true,
                replyToMsgid = "m2",
                dedupKey = "m7",
            ),
            ...
            MessageEntity(
                ...
                sender = "bob",
                kind = MessageKind.PRIVMSG,
                text = "and a picture https://example.com/cat.png",
                dedupKey = "m5",
            ),
            MessageEntity(
                id = 4,
