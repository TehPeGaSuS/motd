...
class DiagnosticLoggerTest {
    ...
    fun cleanUp() {
        context
            .getSharedPreferences("diagnostic_logging", Context.MODE_PRIVATE)
            .edit()
            .clear()
            .commit()
    ...
    @Test
    fun disabledLoggerDoesNotEvaluateOrExportEvents() =
        runTest {
    ...
    @Test
    fun enablingStartsFreshOrderedTraceAndPersistsPreference() =
        runTest {
    ...
    @Test
    fun journalRotationKeepsRecentEventsWithinTwoBoundedFiles() =
        runTest {
            val logger =
