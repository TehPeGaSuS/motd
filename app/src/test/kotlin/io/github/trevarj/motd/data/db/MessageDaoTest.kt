...
class MessageDaoTest {
    ...
    @Test
    fun invitationInbox_keepsActionableAndResolvedEventsButExcludesHistoricalPlayback() =
        runTest {
    ...
    @Test
    fun dedupKeyIsDiagnostic_directDaoInsertsDoNotClaimCanonicalIdentity() =
        runTest {
            val dao = db.messageDao()
    ...
    @Test
    fun msgidUniquenessLivesInNetworkScopedAliasStore_notDirectDao() =
        runTest {
            val dao = db.messageDao()
    ...
    @Test
    fun msgidUniqueness_nullMsgidsCoexist() =
        runTest {
    ...
    @Test
    fun observeCanonicalMsgid_followsEventRedirectAfterCoalescence() =
        runTest {
            val dao = db.messageDao()
            val winnerId =
                dao
    ...
    @Test
    fun findSelfMsgidlessCandidate_matchesMsgidlessSelfRow_ignoresMsgidBearing() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
    ...
    @Test
    fun directDaoDoesNotDeduplicateHistoryOverlapOutsideCanonicalStore() =
        runTest {
            val dao = db.messageDao()
            val label = "lbl-1"
    ...
    @Test
    fun findSelfEchoCandidate_pendingRow_matchesEvenOutsideTimeWindow() =
        runTest {
            val dao = db.messageDao()
    ...
    @Test
    fun findSelfEchoCandidate_confirmedRow_outsideWindow_doesNotMatch() =
        runTest {
            val dao = db.messageDao()
    ...
    @Test
    fun ftsRoundTrip_matchesTextAndSender_viaSanitizedQuery() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
    ...
    @Test
    fun firstUnreadOtherTime_anchorsOnOther_notOwnMessages() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
    ...
    @Test
    fun firstUnreadOtherTime_onlyOwnMessagesPastMarker_returnsNull() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
