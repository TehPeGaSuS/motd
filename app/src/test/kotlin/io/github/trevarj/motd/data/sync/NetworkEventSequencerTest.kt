...
class NetworkEventSequencerTest {
    @Test
    fun sameNetwork_isSerialized_whileDifferentNetworksProceed() =
        runTest {
    ...
    @Test
    fun evictionAndClear_releaseSequencerEntries() =
        runTest {
            val sequencer = NetworkEventSequencer()
    ...
    fun eviction_waitsForExistingUsers_beforeAllowingANewEntry() =
        runTest {
            val sequencer = NetworkEventSequencer()
