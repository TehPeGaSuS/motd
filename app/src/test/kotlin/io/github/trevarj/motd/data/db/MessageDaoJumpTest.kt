...
class MessageDaoJumpTest {
    ...
    @Test fun byMsgid_found_and_absent() =
        runTest {
    ...
    @Test fun countNewerThan_newestRow_isZero() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
    ...
    @Test fun countNewerThan_tiedServerTime_brokenById() =
        runTest {
            val dao = db.messageDao()
    ...
    @Test fun countNewerThan_timeApproximation_boundaries() =
        runTest {
            val dao = db.messageDao()
            dao.insertAll(
                listOf(
